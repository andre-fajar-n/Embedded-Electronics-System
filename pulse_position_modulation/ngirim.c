...
unsigned int waktu_on = 2400, waktu_off=16000, header_start=8000;
//long int header_stop=24800;
...
PORTC=(0<<PORTC7) | (0<<PORTC6) | (1<<PORTC5) | (1<<PORTC4) | (0<<PORTC3) | (0<<PORTC2) | (0<<PORTC1) | (0<<PORTC0);
